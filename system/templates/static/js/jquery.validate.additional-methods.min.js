...
jQuery.validator.addMethod("lettersdigits",function(a,b){return this.optional(b)||/^[a-z-0-9-_.-]+$/i.test(a);},"Letters, digits, . - and _ only please");
jQuery.validator.addMethod("notEqualTo",function(a,b,c){return this.optional(b)||a!=$(c).val();},"Please specify a different value");